...
* [Part III - OpenTX Lua API Reference](part_iii_-_opentx_lua_api_reference.md)
   ...
   * [Model Functions](model/model_functions.md) [//]: <> (LUADOC-BEGIN:model)
      ...
      * [model.deleteFlightModes()](model/deleteFlightModes.md)
      ...
      * [model.getFlightMode(index)](model/getFlightMode.md)
      ...
      * [model.resetSensor(sensor)](model/resetSensor.md)
      ...
      * [model.setFlightMode(index, params)](model/setFlightMode.md)
   ...
   * [Lcd Functions](lcd/lcd_functions.md) [//]: <> (LUADOC-BEGIN:lcd)
      ...
      * [lcd.getColor(area)](lcd/getColor.md)
